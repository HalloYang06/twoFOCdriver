...
#include <stdlib.h>
#include <string.h>
#include "ecat_platform_stm32h7.h"
...
#define ESC_16BIT_ACCESS                          1 //This define was already evaluated by ET9300 Project Handler(V. 1.5.2.0)!
#endif

/** 
ESC_32BIT_ACCESS: If the microcontroller only supports 32Bit access to the ESC. */
#ifndef ESC_32BIT_ACCESS
#define ESC_32BIT_ACCESS                          0 //This define was already evaluated by ET9300 Project Handler(V. 1.5.2.0)!
#endif
...
#define ECAT_TIMER_INT                            0 //This define was already evaluated by ET9300 Project Handler(V. 1.5.2.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x044 //This define was already evaluated by ET9300 Project Handler(V. 1.5.2.0)!
#endif
